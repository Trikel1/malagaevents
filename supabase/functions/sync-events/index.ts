...
const VENUE_ALIASES: Record<string, string> = {
  ...
  'sala la garrapata': 'La Garrapata',
  'la garrapata malaga': 'La Garrapata',
  'la garrapata málaga': 'La Garrapata',
  'la garrapata bar': 'La Garrapata',
  'lagarrapata': 'La Garrapata',
  'lagarrapatabar': 'La Garrapata',
 ...
 * lives in ./parse-date.ts so the concrete production cases (Estepona among
 * them) are covered by regression tests.
 */
